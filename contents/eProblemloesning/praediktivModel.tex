...
\noindent
En ikke-parametrisk model kan opbygges som en matematisk model eller en computerbaseret databehandlingsmodel (på engelsk: computational models). Matematiske modeller er mindre optimale at avende ved ikke-parametriske datasæt\fxnote{HVORFOR? Dette skal uddybes}. Af denne årsag fokuserer projektet fremadrettet på computerbaseret databehandling, da denne egner sig bedst til det tilgængelige ikke-parametriske datasæt\fxnote{HVORFOR? Dette skal uddybes}.\cite{Sheskin2000} 
